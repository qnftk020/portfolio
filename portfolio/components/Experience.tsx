          ...
          >
            ...
            <div>
              <div className="flex flex-wrap items-start gap-x-3 gap-y-1 mb-2">
                <h3 className="font-serif text-xl font-medium text-white leading-tight">
                  {exp.role}
                </h3>
                <span className="font-mono text-xs text-white/40 mt-1">@</span>
                <span className="font-serif text-xl italic text-accent/80 leading-tight">
                  {exp.org}
                </span>
              </div>
              ...
              {exp.link && (
                <a
                  ...
                  className="inline-block mt-3 font-mono text-[11px] tracking-wider text-accent hover:text-white transition-colors hover-underline"
                >
                  View website →
                </a>
              )}
